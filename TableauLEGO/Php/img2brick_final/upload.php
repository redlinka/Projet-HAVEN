...
<body class="bg-light d-flex flex-column min-vh-100">
    ...
    <div class="container flex-grow-1 d-flex align-items-center justify-content-center py-5 center-upload">

        <div class="top-center">
            <h2 class="title">DRAG YOUR IMAGE HERE</h2>
            <div class="suported" data-i18n="index.supported">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="form">
            ...
            <div id="dropArea">
                <img src="assets/lego-man.svg" alt="an image of a lego man" style="width: 100%; height:auto;">
